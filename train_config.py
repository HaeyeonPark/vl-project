...
def parse_args():
    ...
    parser.add_argument('--pretrained', action='store_true', default=False, help='whether or not to restore the pretrained visual model')
    ...
    parser.add_argument('--epochs_decay', type=str, default='20_30_40', help='#epoches when learning rate decays')
